...
class ControllerCheckoutOCUCart extends Controller {

    public function index()
    {
        $this->language->load('checkout/ocu_cart');

        $this->data['text_qty_items']    = $this->language->get('text_qty_items');
        $this->data['text_cart_total_1'] = $this->language->get('text_cart_total_1');
        $this->data['text_cart_total_2'] = $this->language->get('text_cart_total_2');
        $this->data['text_cart_total_3'] = $this->language->get('text_cart_total_3');
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if (isset($this->request->post['quantity']) || isset($this->request->post['remove']) || isset($this->request->post['voucher'])) {
                ...
                $this->redirect($this->url->link('checkout/ocu_cart'));
            }
        }
        ...
        $this->document->setTitle($this->language->get('heading_title'));
          ...
          $this->data['breadcrumbs'][] = array(
            'href'      => $this->url->link('checkout/ocu_cart'),
        ...
        if ($this->cart->hasProducts() || (isset($this->session->data['vouchers']) && $this->session->data['vouchers'])) {
            ...
            $this->data['action'] = $this->url->link('checkout/ocu_cart');
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/ocu_cart.tpl')) {
                $this->template = $this->config->get('config_template') . '/template/checkout/ocu_cart.tpl';
            } else {
                $this->template = 'default/template/checkout/ocu_cart.tpl';
            }
    ...
    public function update()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/ocu_cart.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/common/ocu_cart.tpl';
        } else {
            $this->template = 'default/template/common/ocu_cart.tpl';
        }
